<?php
 ...
 $mhSmtpMail_Server     = "smtp.bernerandstafford.ru";       // Укажите адрес SMTP-сервера
 $mhSmtpMail_Port       = "25";                    // Порт SMTP-сервера, как правило 25
 $mhSmtpMail_Username   = "lg@bernerandstafford.ru"; // Имя почтового ящика (пользователя)
 $mhSmtpMail_Password   = "m5o682h";              // и пароль к нему.
